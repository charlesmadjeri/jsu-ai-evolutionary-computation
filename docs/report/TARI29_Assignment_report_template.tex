...
Experiment: cost impact on generations number/population ratio in the case of three datasets

Goal: seeing if the cost evolution creates some kind of pattern by changing the ratio between the number of generations and the population size

Tested datasets: eil76, pr136, a280

Method of testing: fine-tuning every dataset using the predefined range established within the config.py file, generating 20 parameter sets for each
